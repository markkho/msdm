...
from pyrlap_old.core.reward_function import RewardFunction
from pyrlap_old.algorithms.valueiteration import ValueIteration
from pyrlap_old.core.util import sample_prob_dict, bidict
class GridWorld(MDP):
    def __init__(self,
                 width=None,
                 height=None,
    ...
    def plot(self,
        ...
        from pyrlap_old.domains.gridworld.plotter import GridWorldPlotter, \
            DISTINCT_COLORS
